({
    ...
    handleBackClick: function (component, event, helper) {
        ...
        var cmpEvent = component.getEvent("previousInStep2ClientForm");
        cmpEvent.setParams({
    ...
    handleSubmitForm: function (component, event, helper) {
        if (component.get("v.volunteerType") === undefined) {
            alert("Please the referral form type");
            return;
        }
        ...
        if (allValid) {
            ...
            action.setCallback(this, function (response) {
                if (response.getState() == "SUCCESS") {
                    ...
                    alert('There was an error updating the registration details. Please contact us.');
